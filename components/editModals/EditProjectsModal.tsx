...
export default function EditProjectsModal() {
  const { activeEditModal, closeEditModal, data, updateProjects, uploadImageFile } = usePortfolio();
  ...
  const handleCoverImageUpload = async (index: number, file: File | null) => {
    if (!file) return;
    ...
    try {
      ...
      console.error("Error uploading project image to public/uploads/:", err);
                  ...
                  <div className="space-y-3">
                    {proj.coverImage && (
                      <div className="space-y-2">
                        ...
                        <button
                          ...
                          className="px-2.5 py-1 rounded-lg bg-red-950/60 border border-red-900/60 text-red-300 text-[11px] font-semibold hover:bg-red-600/90 hover:text-white transition-colors"
                        >
                          Remove cover image
                        </button>
                      </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-12 gap-3 items-center">
                      <div className="sm:col-span-6">
                        <label className="inline-flex items-center justify-center gap-2 w-full px-4 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-500 text-white font-semibold cursor-pointer text-xs shadow-md transition-all">
